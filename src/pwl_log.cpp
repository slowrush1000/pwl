...
pwl::Log::Log(const std::string& loggerName, const std::string& logFileName) : mLoggerName(loggerName), mLogFileName(logFileName)
{
    try
    {
        mConsoleSink    = std::make_shared<spdlog::sinks::stdout_color_sink_mt>();
...
void                                
pwl::Log::setLoggerName(const std::string& loggerName)
{
    mLoggerName = loggerName;
}

const std::string&                  
pwl::Log::getLoggerName() const
{
    return mLoggerName;
}

void                                
pwl::Log::setLogFileName(const std::string& logFileName)
{
    mLogFileName    = logFileName;
}

const std::string&                  
pwl::Log::getLogFileName() const
{
    return mLogFileName;
}

void                                
pwl::Log::changeLogLevel(const spdlog::level::level_enum logLevel)
{
