...
void            
pwl::changeStr(std::string& str, const std::string& from, const std::string& to)
{
    if(true == from.empty())
    {
        return;
...
void            
pwl::setCasesensitive(std::string& str, const bool casesensitive)
{
...
bool
pwl::isEqual(const std::string& str1, const std::string& str2, const bool casesensitive)
{
...
bool
pwl::isEqualCasesensitive(const std::string& str1, const std::string& str2)
{
    return str1 == str2;
}

bool
pwl::isEqualIncasesensitive(const std::string& str1, const std::string& str2)
{
...
bool            
pwl::isEqual(const unsigned char str1, const unsigned char str2, const bool casesensitive)
{
    if (true == casesensitive)
...
bool            
pwl::isEqualCasesensitive(const unsigned char str1, const unsigned char str2)
{
    return str1 == str2;
}

bool            
pwl::isEqualIncasesensitive(const unsigned char str1, const unsigned char str2)
{
    return tolower(str1) == tolower(str2);
}

bool            
pwl::isEqual(const float f1, const float f2, const float max_rel_diff)
{
...
bool            
pwl::isEqual(const double d1, const double d2, const double max_rel_diff)
{
...
std::string     
pwl::makeLine(const std::vector<std::string>& tokens, const std::size_t fromPos, const std::size_t toPos, const std::string& delims)
{
